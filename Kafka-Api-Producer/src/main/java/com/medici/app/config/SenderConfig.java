...
public class SenderConfig {
	...
	@Bean
	public ReplyingKafkaTemplate<String, KafkaPrimeModel, KafkaPrimeModel> replyKafkaTemplate() {
		ReplyingKafkaTemplate<String, KafkaPrimeModel, KafkaPrimeModel> replyingKafkaTemplate = new ReplyingKafkaTemplate<>(producerFactory(), replyContainer());
	...
	@Bean
	public KafkaMessageListenerContainer<String, KafkaPrimeModel> replyContainer() {
		ContainerProperties containerProperties = new ContainerProperties(jsonTopicReply);
		return new KafkaMessageListenerContainer<>(consumerFactory(), containerProperties);
	}

	@Bean
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, KafkaPrimeModel>> kafkaListenerContainerFactory() {
